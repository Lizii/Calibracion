<?php
	...
	$pdf->SetXY(65, 72);
	$pdf->SetTextColor(31, 73, 125); // Color Azul
	$pdf->Multicell(44, 3.5, utf8_decode($DETEC), 0, 1, 'C', 'F');
	...
	$pdf->SetFillColor(81, 180, 241); // Color Azul
	// C (Centra el texto de la celda), F (Rellena la celda con el color seleccionado)
	$pdf->Cell($cellsize, 5, utf8_decode("(3) Descripción de la no-conformidad (Description of the non-conformant)"), 1, 1, 'C', 'F');

<?php
	...
	if ($objCon->conectar()==true)
	{
		...
		if($resultado>0 )
		{
			...
			{
				$f_anio_envio=substr($fila['Fecha_Envio'],0,4);
				$f_mes_envio=substr($fila['Fecha_Envio'],5,2);
				$f_dia_envio=substr($fila['Fecha_Envio'],8,2);
				...
				$objPHPExcel->setActiveSheetIndex(0)
				    	    ...
				    	    ->setCellValue('E'.$i, $f_mes_envio.'/'.$f_dia_envio.'/'.$f_anio_envio)
			...
			$estiloTituloColumnas = array(
	            ...
	            'borders' => array(
        			'allborders' => array(
          				'style' => PHPExcel_Style_Border::BOR DER_MEDIUM,
          				'color' => array(
          					'argb' => 'FF000000'
          				),
        			)

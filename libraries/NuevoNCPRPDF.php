<?php
	...
	$pdf->cell(70, 10, "DOCUMENTO NO.:   VL-PA-SGC-001-F02", 1, 1, 'C', 'F');
	...
	$pdf->SetFont('Arial', 'B', '8');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->cell(79, 3, "DOCUMENT: NON-CONFORMING PRODUCT REPORT", 0, 1, 'L', 'F');

	$pdf->SetXY($x+2.5, $t1+13.8);
	$pdf->SetFont('Arial', 'B', '8');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->cell(79, 3, "REVISION: 4", 0, 1, 'L', 'F');
	...
	$pdf->SetFont('Arial', 'B', '8');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->cell(121.5, 10, "NOMBRE DEL DOCUMENTO:    NON-CONFORMING PRODUCT REPORT (ENGLISH)", 1, 1, 'C', 'F');
	...
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(40.5, 5, "Folio 1 2 3", 0, 1, 'C','F');
	...
	$pdf->SetFont('Arial', '', '7');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(162, 4, "REPORTADO POR 1 2 3", 1, 1, 'L', 'F');
	...
	$pdf->SetFont('Arial', '', '7');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(162, 4, "GENERADO POR 1 2 3", 1, 1, 'L', 'F');
	...
	$pdf->SetFont('Arial', '', '7');
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(121.5, 4, "GENERADO POR 1 2 3", 1, 1, 'L', 'F');
	...
	$pdf->SetTextColor(0, 0, 0); // Color negro
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(202, 4, "GENERADO POR 1 2 3", 1, 1, 'L', 'F');
	...
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Rect($x, $t3, $y, $c);
	$pdf->Multicell(202, 3, "GENERADO POR 1 2 3 asdhasdhlsduhl haslduhasdhaouishd ihasduhaisudhoiua oipjsdnasdu jsidjuiejwo l;aksdkjalskjd jlkjlkjhf kj asdkasdjalsdjk sksjd dheeipi sd;lkfs;dkjfksd sdhfioudb alskdj", 0, 1, 'L', 'F');
	...
	$pdf->SetTextColor(0, 0, 0); // Color negro
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(101, 4, "GENERADO POR 1 2 3", 1, 1, 'L', 'F');
	...
	$pdf->SetTextColor(0, 0, 0); // Color negro
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Multicell(202, 3, "GENERADO POR 1 2 3 sssssssssssssssssssssssssssssssssssssss ssssssssssssssssssssssssssssssssssssss fggggggggggggggggggggggggggggggggggggggggggggg oje;wjehsdf jsndksndklj", 0, 1, 'L');
	// $pdf->Rect(X, Y, Ancho, Alto);   
	...
	$pdf->SetTextColor(0, 0, 0); // Color negro
	$pdf->SetFillColor(255, 255, 255); // Color blanco
	$pdf->Cell(202, 6, "GENERADO POR 1 2 3", 1, 1, 'L', 'F');

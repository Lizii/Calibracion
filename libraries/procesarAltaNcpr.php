<?php
	...
	if ($objCon->conectar()==true)
	{
		...
		*/
		...
		if($_POST['origen_codigo']=="AF001")
		{
			$RECHAZO='AF001';
			$RECHAZODESCRIPCION='CORTE FUERA DE ESPECIFICACION';
			$LOCALIZADEFECTO='ALCUT';
			$LOCALIZADEFECTODESC='AL FAB CUTTING / FAB AL CORTE';
		}
		if($_POST['origen_codigo']=="AF002")
		{
			$RECHAZO='AF002';
			$RECHAZODESCRIPCION='DAÑO AL CORTAR';
			$LOCALIZADEFECTO='ALCUT';
			$LOCALIZADEFECTODESC='AL FAB CUTTING / FAB AL CORTE';
		}
		if($_POST['origen_codigo']=="AF003")
		{
			$RECHAZO='AF003';
			$RECHAZODESCRIPCION='MATERIAL EQUIVOCADO';
			$LOCALIZADEFECTO='ALCUT';
			$LOCALIZADEFECTODESC='AL FAB CUTTING / FAB AL CORTE';
		}
		if($_POST['origen_codigo']=="AF004")
		{
			$RECHAZO='AF004';
			$RECHAZODESCRIPCION=strtoupper($_POST['origen_otro']);
			$LOCALIZADEFECTO='ALCUT';
		...
		{
			$RECHAZO='DC004';
			$RECHAZODESCRIPCION='RECHUPE';
			$LOCALIZADEFECTO='DCAST';
			$LOCALIZADEFECTODESC='DIE CASTING';
		}
		if($_POST['origen_codigo']=="DC005")
		{
			$RECHAZO='DC005';
			$RECHAZODESCRIPCION='FALTA DE MATERIAL';
			$LOCALIZADEFECTO='DCAST';
			$LOCALIZADEFECTODESC='DIE CASTING';
		}
		if($_POST['origen_codigo']=="DC006")
		{
			$RECHAZO='DC006';
			$RECHAZODESCRIPCION='EXCESO DE MATERIAL';
			$LOCALIZADEFECTO='DCAST';
			$LOCALIZADEFECTODESC='DIE CASTING';
		}
		if($_POST['origen_codigo']=="DC007")
		{
			$RECHAZO='DC007';
			$RECHAZODESCRIPCION='GRIETAS';
			$LOCALIZADEFECTO='DCAST';
			$LOCALIZADEFECTODESC='DIE CASTING';
		}
		if($_POST['origen_codigo']=="DC008")
		{
			$RECHAZO='DC008';
			$RECHAZODESCRIPCION='MAL CORTE';
			$LOCALIZADEFECTO='DCAST';
			$LOCALIZADEFECTODESC='DIE CASTING';
		}
		if($_POST['origen_codigo']=="DC009")
		{
			$RECHAZO='DC009';
			$RECHAZODESCRIPCION=strtoupper($_POST['origen_otro']);
			$LOCALIZADEFECTO='DCAST';
		...
		{
			$RECHAZO='LD005';
			$RECHAZODESCRIPCION='PRODUCTO DAÑADO DEL PROVEEDOR';
			$LOCALIZADEFECTO='LEDAS';
			$LOCALIZADEFECTODESC='LED ASSEMBLY / ENSAMBLE LED';
		}
		...
		{
			$RECHAZO='LD006';
			$RECHAZODESCRIPCION='COMPONENTE DAÑADO DURANTE ENSAMBLAJE';
			$LOCALIZADEFECTO='LEDAS';
			$LOCALIZADEFECTODESC='LED ASSEMBLY / ENSAMBLE LED';
		}
		...
		{
			$RECHAZO='PC006';
			$RECHAZODESCRIPCION='RESIDUO DE AGUA';
			$LOCALIZADEFECTO='PCOAT';
			$LOCALIZADEFECTODESC='POWDER COAT / PINTURA';
		}
		...
		{
			$RECHAZO='PC018';
			$RECHAZODESCRIPCION='PELUSA';
			$LOCALIZADEFECTO='PCOAT';
			$LOCALIZADEFECTODESC='POWDER COAT / PINTURA';
		}
		if($_POST['origen_codigo']=="PC019")
		{
			$RECHAZO='PC019';
			$RECHAZODESCRIPCION='PRUEBA DE CONTINUIDAD';
			$LOCALIZADEFECTO='PCOAT';
			$LOCALIZADEFECTODESC='POWDER COAT / PINTURA';
		}
		if($_POST['origen_codigo']=="PC020")
		{
			$RECHAZO='PC020';
			$RECHAZODESCRIPCION='MARCAS';
			$LOCALIZADEFECTO='PCOAT';
			$LOCALIZADEFECTODESC='POWDER COAT / PINTURA';
		}
		if($_POST['origen_codigo']=="PC021")
		{
			$RECHAZO='PC021';
			$RECHAZODESCRIPCION=strtoupper($_POST['origen_otro']);
			$LOCALIZADEFECTO='PCOAT';

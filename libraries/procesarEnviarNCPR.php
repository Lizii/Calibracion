	...
	if ($objCon->conectar()==true)
	{
		...
		if($destino=="MEXICO")
		{
			...
			{	
				...
				$mail->AddAddress("andresortega@visionairelighting.com");
			}
			...
			$mail->addCC("carlosgonzalez@visionairelighting.com");
			...
			$mail->addBCC("csolis@visionairelighting.com");
			$mail->addBCC("daguirre@visionairelighting.com");
			$mail->addBCC("afregoso@visionairelighting.com");
			$mail->addBCC("slugo@visionairelighting.com");
		...
		else if($destino=="RD")
		{
			...
			$mail->addCC("elambarena@visionairelighting.com");
